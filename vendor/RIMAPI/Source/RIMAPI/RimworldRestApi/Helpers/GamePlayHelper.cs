...
namespace RIMAPI.Helpers
{
    public static class GamePlayHelper
    {
        ...
        public static GameStateDto GetGameStateDto()
        {
            ...
            try
            {
                // Avoid touching map, tick, storyteller, or UI objects from the HTTP
                // worker thread while RimWorld is still in menus/long-event startup.
                // Several of those getters can block until the main thread advances.
